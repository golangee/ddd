...
// SetFieldEnvironmentVariable connects the given field with a specific name from the environment variable.
func (c Field) SetEnvironmentVariable(environmentVariable string) {
	c.field.PutValue(kEnvironmentVariable, environmentVariable)
}

// FieldEnvironmentVariable extracts the environment variable.
...
// SetFieldProgramFlagVariable connects the given field with a specific name from the program flag variable.
func (c Field) SetProgramFlagVariable(flagVariable string) {
	c.field.PutValue(kProgramFlagVariable, flagVariable)
}

// FieldProgramFlagVariable extracts the program flag variable.
