			...
			Context(
				...
				DomainCore(
					API(
						...
						Repository("Reader", ReadOne|CreateOne|DeleteOne|UpdateOne|DeleteAll|CountAll|ReadAll,
							Func("GroupByCategory",
								"...groups by category id",
								In(Var("category", String, "...is a name")),
								Out(Return(List("Reader")), Return(Error)),
							),
						),
					),
					Factories(),
